...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="food">
    <div style="background-color:teal; color:white; padding:4px; margin-top:0px">
    ...
    <div style="background-color:#E0E0E0; color:black; padding:15px; ; width:100%; box-sizing:border-box;font-size:10pt;padding-left:20px;">
    <p style="margin: 0; ">
